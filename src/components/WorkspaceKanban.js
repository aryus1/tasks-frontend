    ...
    return (
        <div className="p-4 md:p-8 lg:px-24 lg:py-12 flex flex-col gap-6">
            ...
            <div className="grid gap-4 md:grid-cols-2">
                <div className="bg-[#D0E3FF] p-4 rounded-xl" onClick={() => navigate(`/dashboard/workspace/${encodeURIComponent('Trabalhos faculdade')}`)}>
                ...
                <div className="bg-[#F7D6D9] p-4 rounded-xl" onClick={() => navigate(`/dashboard/workspace/${encodeURIComponent('Cursos online')}`)}>
                    <div className="flex gap-4 items-center">
